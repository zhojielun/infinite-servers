...
const STRINGS = {
  en: {
    ...
    "nav.refresh": "Refresh",
    "toast.refreshSuccess": "Refreshed",
    "nav.telegramCheck": "Send Telegram Alert",
    "nav.sortAlpha": "Sort A-Z",
    "nav.logout": "Logout",
    ...
    "expiry.legend.past": "Expired",
    "expiry.legend.remaining": "Remaining",
    "expiry.legend.expiry": "Expiring",
  ...
  zh: {
    ...
    "nav.dashboard": "仪表盘",
    "nav.refresh": "刷新",
    "toast.refreshSuccess": "刷新成功",
    "nav.telegramCheck": "发送 Telegram 提醒",
    "nav.sortAlpha": "字母排序",
    "nav.logout": "登出",
    "settings.title": "设置",
    "settings.save": "保存",
    ...
    "expiry.legend.past": "已过期",
    "expiry.legend.remaining": "剩余时间",
    "expiry.legend.expiry": "即将到期",
